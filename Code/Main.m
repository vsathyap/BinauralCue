...
s_name = 'C:/Users/user/Documents/MATLAB/Thesis/Dataset/Sound_1.wav';    % target .wav file.

U_names_all = {'C:/Users/user/Documents/MATLAB/Thesis/Dataset/Sound_2.wav',...  % interferers' .wav files.
    'C:/Users/user/Documents/MATLAB/Thesis/Dataset/Sound_3.wav',...
    'C:/Users/user/Documents/MATLAB/Thesis/Dataset/Sound_4.wav'};
...
elseif(strcmp(CPSDM_sel,'noise'))
    ...
    [x_hat_L,x_hat_R,Ws_L,Ws_R] =... %x_hat(:,Inter,Method)
        BinauralProcessing(method,numbMethods,Y,X,A,B,N,NFFT,ref_mics,c,ILD_max,version,Fs,vd_L);
end
...
audiowrite(['C:\Users\user\Documents\MATLAB\Thesis\SubjectiveTest\Test_AudioFiles\Sound_Sc' num2str(Scenario) '_Unprocessed_Target.wav'],X_Pre_rms,Fs);
for r = 1:numbInter
    Y_Pre_rms(:,:,r) = [V(ref_mics(1),:,r)' V(ref_mics(2),:,r)']./(sum([V(ref_mics(1),:,r) V(ref_mics(2),:,r)].^2).^(0.5));
    audiowrite(['C:\Users\user\Documents\MATLAB\Thesis\SubjectiveTest\Test_AudioFiles\Sound_Sc' num2str(Scenario) '_Unprocessed_r' num2str(r) '.wav'],Y_Pre_rms(:,:,r),Fs);
end
...
for met = 1:numbMethods
    ...
    audiowrite(['C:\Users\user\Documents\MATLAB\Thesis\SubjectiveTest\Test_AudioFiles\Sound_Sc' num2str(Scenario) '_m' num2str(met) 'Target.wav'],X_rms(:,:,met),Fs);

    for r = 1:numbInter
        Y_rms(:,:,r,met) = [Y_N_L(:,r,met) Y_N_R(:,r,met)]./(sum([Y_N_L(:,r,met)' Y_N_R(:,r,met)'].^2).^(0.5));
        audiowrite(['C:\Users\user\Documents\MATLAB\Thesis\SubjectiveTest\Test_AudioFiles\Sound_Sc' num2str(Scenario) '_m' num2str(met) '_r' num2str(r) '.wav'],Y_rms(:,:,r,met),Fs);
    end
end
